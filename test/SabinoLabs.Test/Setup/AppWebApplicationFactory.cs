...
using SabinoLabs.Crosscutting.Constants;
using SabinoLabs.Test.Configuration;
...
namespace SabinoLabs.Test.Setup
{
        ...
        where TEntryPoint : class
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder) =>
            builder
                .UseSolutionRelativeContentRoot("src/SabinoLabs.Api")
        ...
        public TService GetRequiredService<TService>()
        {
            ...
            {
                _serviceProvider = Server.Host.Services.CreateScope().ServiceProvider;
            }
            ...
            string authenticationType)
        {
            ...
            {
                roles = new HashSet<string> {RolesConstants.USER};
            }

            List<Claim> claims = new List<Claim> {new(SecurityStartup.UserNameClaimType, name)};
