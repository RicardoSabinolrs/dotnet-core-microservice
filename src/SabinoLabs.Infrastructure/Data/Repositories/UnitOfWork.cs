...
using SabinoLabs.Infrastructure.Data.Extensions;
...
namespace SabinoLabs.Infrastructure.Data.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public void UpdateState<TEntity>(TEntity entity, EntityState state) => _context.Entry(entity).State = state;

        public void SetEntityStateModified<TEntiy, TProperty>(TEntiy entity,
            Expression<Func<TEntiy, TProperty>> propertyExpression) where TEntiy : class where TProperty : class =>
        ...
        {
            using Task<int> saveChangeTask = _context.SaveChangesAsync(cancellationToken);
        ...
        public void AddOrUpdateGraph<TEntiy>(TEntiy entity) where TEntiy : class =>
            ...
            {
                EntityEntry alreadyTrackedEntity = _context.ChangeTracker.Entries()
