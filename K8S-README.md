...
$ kubectl scale deployment <app-name> --replicas <replica-count> -n sabino-labs
...
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image> -n sabino-labs
